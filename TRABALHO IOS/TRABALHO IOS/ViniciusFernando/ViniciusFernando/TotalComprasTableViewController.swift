//
//  TotalComprasTableViewController.swift
//  ViniciusFernando
//
...
class TotalComprasTableViewController: UITableViewController {
    ...
    */
    ...
    extension TotalComprasTableViewController: NSFetchedResultsControllerDelegate {
